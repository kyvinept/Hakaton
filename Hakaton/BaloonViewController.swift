...
class BaloonViewController: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        greetingLabel.text = "Нашему отделу исполняется 10 лет и хотя мы совсем недавно стали его частью, но мы уже успели проникнуться атмосферой отдела, принять участие в разработке и мы надеемся, что отдел будет только развиваться и становиться лучше, будет еще больше интересных проектов, количество разработчиков будет только увеличиваться, а качество продукции станет лучшим на рынке."
